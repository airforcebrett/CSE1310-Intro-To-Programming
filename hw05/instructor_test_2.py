...
def main():
    ...
    # smallest_1 
    command_list = [[" [[84,76,42,26], [51,40,78,33]]","smallest_1(M,3)", 33],
                    [" [[84,76,42,26], [51,40,78,33]]","smallest_1(M,0)", 84],
                    [" [[84,56],[2,76],[4,99],[26,8]]", "smallest_1(M,1)", 99],
                    [" [[84],[2],[1],[26]]", "smallest_1(M,0)", 2],
                    ]            
    test_general(command_list)


    # smallest_    
    command_list = [[" [[84,76,42,26], [51,40,78,33]]","smallest_all(M)", [84, -1, 42, 33]],
                    [" [[84,56],[2,76],[4,99],[26,8]]", "smallest_all(M)", [2,99]],
                    [" [[84],[2],[1],[26]]", "smallest_all(M)", [2]],
                    ]
    test_general(command_list)
